...
public class StringMethodsExample {
  public static void main(String[] args) {
    ...
    String text = """
        We realizes that while our workers were thriving, the surrounding villages were still suffering.
        ...
        The alternative mentioned here is the Tata Nano, which soon after came as the worlds cheapest car on retail at a starting price of only Rs 1 lakh.
    ...
    // compareTo()
    String otherText =
        "We realized that while our workers were thriving, the surrounding villages were still suffering.";
    ...
    System.out.println(
        "Equals ignore case other text: " + equalsIgnoreCaseResult + "\n");

    // format()
    String formattedText =
        String.format("The text starts with '%s' and ends with '%s'",
