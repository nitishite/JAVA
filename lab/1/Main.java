class Bank {
  ...
  public void openAccount(String accountType, double initialDeposit) {
    System.out.println(
        accountType +
        " account opened successfully with an initial deposit of $" +
        initialDeposit);
  }
...
public class Main {
  public static void main(String[] args) {
    ...
    bank1.openAccount("Checking", 1000); // Checking account opened successfully
                                         // with an initial deposit of $1000
